...
<div class="ett-trading-tool">
    ...
    <div class="ett-trading-filters">
        ...
        <div class="ett-filter-col">
            ...
            <div class="ett-field" id="ett-char-rec-field">
                ...
                <select id="ett-character" name="ett_character">
        ...
        <!-- Right: Market Group + Capital + Meta -->
        <div class="ett-filter-col">

            <div class="ett-field">
                <label for="ett-market-group">Filter Market Group</label>
                <select id="ett-market-group" name="ett_market_group">
    ...
    <button type="button" class="ett-trading-btn" id="ett-btn-generate-list">Generate List</button>
